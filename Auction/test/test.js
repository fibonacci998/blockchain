...
contract('AuctionContract', function (accounts) {
  ...
  it("Should NOT allow to bid more than remaining tokens", function() {
    ...
    ***********/
    return /*<CODE HERE>*/
		auctionInstance.bid(0, 6 ,{from: accounts[1]})
    .then(function (result) {
      /*
  ...
  it("Should NOT allow non owner to reveal winners", function() {
    ...
    ***********/
     return /*<CODE HERE>*/
		auctionInstance.revealWinners({from: accounts[1]})
  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
      return /*<CODE HERE>*/
	  auctionInstance.winners(1, {from: accounts[0]})
    }).then(function(result) {
      /**********
      ...
      ***********/
      return /*<CODE HERE>*/
	  auctionInstance.winners(2, {from: accounts[3]})
    }).then(function(result) {
      /**********
